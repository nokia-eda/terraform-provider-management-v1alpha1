			...
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"rate_limit": schema.Int64Attribute{
						...
						MarkdownDescription: "Rate limit for the gRPC server.",
						Validators: []validator.Int64{
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	rateLimitVal, ok := rateLimitAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`rate_limit expected to be basetypes.Int64Value, was: %T`, rateLimitAttribute))
	}
...
type SpecValue struct {
	...
	RateLimit              basetypes.Int64Value  `tfsdk:"rate_limit"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["rate_limit"] = basetypes.Int64Type{}.TerraformType(ctx)
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"rate_limit":              basetypes.Int64Type{},
