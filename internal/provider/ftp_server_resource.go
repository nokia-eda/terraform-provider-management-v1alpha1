...
const (
	create_rs_ftpServer = "/apps/management.eda.nokia.com/v1alpha1/namespaces/{namespace}/ftpservers"
	read_rs_ftpServer   = "/apps/management.eda.nokia.com/v1alpha1/namespaces/{namespace}/ftpservers/{name}"
	update_rs_ftpServer = "/apps/management.eda.nokia.com/v1alpha1/namespaces/{namespace}/ftpservers/{name}"
	delete_rs_ftpServer = "/apps/management.eda.nokia.com/v1alpha1/namespaces/{namespace}/ftpservers/{name}"
)
