...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	authenticationVal, ok := authenticationAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`authentication expected to be basetypes.BoolValue, was: %T`, authenticationAttribute))
	}
...
type SpecValue struct {
	Authentication basetypes.BoolValue   `tfsdk:"authentication"`
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["authentication"] = basetypes.BoolType{}.TerraformType(ctx)
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			"authentication": basetypes.BoolType{},
